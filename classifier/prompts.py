...
SYSTEM_PROMPT = """You are a legal analysis assistant specialising in EU AI regulation.
...
Output ONLY valid JSON matching this schema (no markdown, no explanation outside JSON):
{
  ...
  "disclaimer": "This output is generated by an automated system and does not constitute legal advice. Classification under the EU AI Act requires case-by-case assessment by qualified legal professionals."
}"""
